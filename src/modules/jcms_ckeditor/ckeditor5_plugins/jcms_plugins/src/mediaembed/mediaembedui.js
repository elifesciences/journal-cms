...
import mediaEmbedIcon from '../../../../icons/mediaEmbed.svg';
...
export default class MediaEmbedUI extends Plugin {
    ...
    const command = editor.commands.get( 'mediaEmbed' );
      ...
      const mediaForm = new MediaFormView( getFormValidators( editor.t, registry ), editor.locale );
			...
			this._setUpDropdown( dropdown, mediaForm, command, 'media', mediaEmbedIcon, 'Insert Media');
    ...
    editor.ui.componentFactory.add( 'mediaEdit', locale => {
      ...
      this._setUpDropdown( dropdown, mediaForm, command, 'media', icons.pencil, 'Edit Media Url');
      this._setUpForm( dropdown, mediaForm, command );
...
export function getFormValidators( t, registry ) {
	return [
		form => {
			if ( !form.url.length ) {
