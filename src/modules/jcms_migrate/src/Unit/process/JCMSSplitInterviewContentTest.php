...
namespace Drupal\Tests\jcms_migrate\Unit\process {
  ...
  /**
   * Tests the split interview content process plugin.
   *
   * @coversDefaultClass \Drupal\jcms_migrate\Plugin\migrate\process\JCMSSplitInterviewContent
   * @group jcms_migrate
   */
  class JCMSSplitInterviewContentTest extends MigrateProcessTestCase {
    ...
    public function testTransform($html, $expected_result) {
      $plugin = new JCMSSplitInterviewContent([], 'jcms_split_content', []);
