 ...
 *
 * @RestResource(
 *   id = "highlight_current_list_rest_resource",
 *   label = @Translation("Highlight current list rest resource"),
 *   uri_paths = {
 *     "canonical" = "/highlights/{list}/current"
 *   }
 * )
 */
class HighlightCurrentListRestResource extends AbstractRestResourceBase {
