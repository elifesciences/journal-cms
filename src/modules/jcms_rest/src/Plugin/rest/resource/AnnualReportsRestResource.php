 ...
 *
 * @RestResource(
 *   id = "annual_reports_list_rest_resource",
 *   label = @Translation("Annual reports list rest resource"),
 *   uri_paths = {
 *     "canonical" = "/annual-reports"
 *   }
 * )
 */
class AnnualReportsRestResource extends AbstractRestResourceBase {
  /**
