...
class CollectionItemRestResource extends AbstractRestResourceBase {
  ...
  public function get($id) {
    ...
    if ($nids) {
      ...
      $response = new JsonResponse($response, Response::HTTP_OK, ['Content-Type' => 'application/vnd.elife.collection+json;version=1']);
      return $response;
    }

    throw new JCMSNotFoundHttpException(t('Collection with ID @id was not found', ['@id' => $id]), NULL, 'application/problem+json');
  }
