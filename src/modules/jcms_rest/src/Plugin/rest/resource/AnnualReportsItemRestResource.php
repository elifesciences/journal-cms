 ...
 *
 * @RestResource(
 *   id = "annual_reports_item_rest_resource",
 *   label = @Translation("Annual reports item rest resource"),
 *   uri_paths = {
 *     "canonical" = "/annual-reports/{year}"
 *   }
 * )
 */
class AnnualReportsItemRestResource extends AbstractRestResourceBase {
  /**
